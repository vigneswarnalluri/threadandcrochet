      ...
      children: [
        {
          ...
          type: 'dropdown',
          children: [
            { id: '1-1', href: '/collections/coats', name: 'Coaster Sets' },
            { id: '1-2', href: '/collections/coats', name: 'Plant Hangers' },
            { id: '1-3', href: '/collections/coats', name: 'Textured Blankets' },
            { id: '1-4', href: '/collections/coats', name: 'Wall Hangers' },
          ],
        },
        {
          id: '2',
          ...
          type: 'dropdown',
          children: [
            { id: '2-1', href: '/collections/jeans', name: 'Granny Square Totes' },
            { id: '2-2', href: '/collections/jeans', name: 'Crossbody Purses' },
            { id: '2-3', href: '/collections/jeans', name: 'Market Shoppers' },
            { id: '2-5', href: '/cart', name: 'My Cart' },
            { id: '2-6', href: '/checkout', name: 'Checkout' },
          ],
        },
        {
          id: '3',
          ...
          type: 'dropdown',
          children: [
            { id: '3-1', href: '/collections/shoes', name: 'Crochet Starter Kits' },
            { id: '3-2', href: '/collections/shoes', name: 'Digital Pattern Packs' },
            { id: '3-3', href: '/blog', name: 'Video Tutorials' },
            { id: '3-4', href: '/about', name: 'Our Artisans' },
          ],
        },
        {
          id: '4',
          ...
          type: 'dropdown',
          children: [
            { id: '4-1', href: '/blog', name: 'Crafting Blog' },
            { id: '4-3', href: '/about', name: 'About Us' },
...
export const getCurrencies = async () => {
  return [
    ...
    <path d="M6 12h12M6 3h12M6 8h12M6 13c3.5 0 6.5-2 6.5-4.5S9.5 4 6 4" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
    <path d="M11 13L6 20" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
</svg>`,
    },
    {
      id: 'USD',
